...
const {Message, StringSession, Image, Video} = require('./Achutty/');
...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please wait.')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('𝚊𝚌𝚑𝚞𝚝𝚝𝚢 𝚠𝚘𝚛𝚔𝚒𝚗𝚐 ' + config.WORKTYPE + ' 𝚗𝚘𝚠 🌸'));
            await conn.sendMessage(conn.user.jid, "ᴀᴄʜᴜᴛᴛʏ ɪꜱ ᴀʟʟ ꜱᴇᴛ", MessageType.text);
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '__ACHUTTY_V2_☠☠_[error] ' +
                                    '\n\n*🥰 ' + error + '*\n'
                                    , MessageType.text);
                            }
                        }
