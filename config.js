...
module.exports = {
    ...
    SESSION: process.env.ACHUTTY_SESSION === undefined ? '' : process.env.ACHUTTY_SESSION,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    AFN: process.env.ALL_CAPTION === undefined ? 'MADE BY ACHUTTY' : process.env.ALL_CAPTION,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'ACHUTTY_V2' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    TALKING_ACHUTTY: process.env.TALKING_ACHUTTY === undefined ? 'false' : process.env.TALKING_ACHUTTY,
